      ...
      <div className="container">
          ...
          <div className="container2">
            <div className="first">
              <div className="profile">
                <div className="content">
                  <div className="info">
                    <img className="img1" src={daniel} alt="daniel" />
                    <div className="personal">
                      <div className="name">Daniel Clifford</div>
                      <div className="qualification">Verified Graduate</div>
                    </div>
                  </div>
                  <img className="quote" src={quote} alt="big-quote" />
                  <h1>
            ...
            <div className="second">
              <div className="profile">
                <div className="content">
                  <div className="info">
                    <img className="img1" src={Jonathan} alt="daniel" />
                    <div className="personal">
          ...
          <div className="container3">
            <div className="third">
              <div className="profile">
                <div className="content">
                  <div className="info">
                    <img className="img1" src={Jeanette} alt="daniel" />
                    <div className="personal">
            ...
            <div className="fourth">
              <div className="profile">
                <div className="content">
                  <div className="info">
                    <img className="img1" src={Patrick} alt="daniel" />
                    <div className="personal">
        ...
        <div className="fifth">
          <div className="profile">
            <div className="content">
              <div className="info">
                <img className="img1" src={Kira} alt="daniel" />
                <div className="personal">
